 ...
 * @author Admin
 */
public class sec extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
             if(sname.isEmpty()){
              ...
              st.executeUpdate("insert into section (Sec_id, Name, Descripion) values ('"+sno+"','"+sname+"','"+des+"')");
        ...
        if(r== -1){
         ...
         try {
            ...
            String a=jTable1.getValueAt(r, 0).toString();
              ...
              Statement st= db.getconnection().createStatement();
              st.executeUpdate("DELETE from section where Sec_id='"+a+"'");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,"enter name");
              ...
              Statement st= db.getconnection().createStatement();
              st.executeUpdate("update section set Name='"+sname+"',Descripion='"+dis+"' where Sec_id='"+sno+"'");
...
public  void tableload(){
        ...
        dtm.setRowCount(0);
         try {
           ResultSet rs= db.getconnection().createStatement().executeQuery("select * from section");
...
public void selectrow(){
 ...
 try {
           ...
           Statement st= db.getconnection().createStatement();
           ResultSet ss =st.executeQuery("SELECT * FROM section WHERE Sec_id='"+a+"' ");
...
public void incnum(){
        ...
        try {
            ...
            ResultSet sp =st.executeQuery("SELECT COUNT(*) AS RowCnt FROM section");
            ...
            while(sp.next()){
                ...
                ResultSet ss =st.executeQuery("SELECT MAX(Sec_id) FROM section");
